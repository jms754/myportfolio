...
//	 	 .append("VALUES (?,?,?,?,?,?,?,systimestamp) ");
		...
		memberVO.setBirth(java.sql.Date.valueOf("2000-02-01"));
	...
	void modifyMember() {
		MemberVO memberVO = new MemberVO();
		memberVO.setId("admin94@admin.com");
		memberVO.setTel("010-8977-1769");
		memberVO.setNickname("전민식");
		memberVO.setRegion("울산");
		memberVO.setBirth(java.sql.Date.valueOf("2000-02-01"));
	...
	@Disabled
	void loginMember() {
		MemberVO memberVO = memberDAO.loginMember("admin94@admin.com", "111111dd");
		assertEquals("admin94@admin.com", memberVO.getId());
		logger.info(memberVO.toString());
	}
	...
	@Disabled
	void findID() {
		String id = memberDAO.findID("010-8977-1769", java.sql.Date.valueOf("2000-02-01"));
	...
	@Disabled
	void ChangePW() {
		int cnt = memberDAO.changePW("admin94@admin.com", "111111ee");
		assertEquals(1, cnt);
	}
	@Test
...
//	@Disabled
	void findPW() {
		MemberVO memberVO = new MemberVO();
		memberVO.setId("test1234@test.com");
		memberVO.setTel("010-2323-2332");
