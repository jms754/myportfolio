...
//	private String gender;		//	GENDER	성별('남','여')				CHAR
	...
	private String region1;		//	REGION	지역				VARCHAR2
	private String region2;		//	REGION	지역				VARCHAR2
	private String region3;		//	REGION	지역				VARCHAR2
//	@NotNull
