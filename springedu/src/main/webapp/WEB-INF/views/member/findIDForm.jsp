...
<head>
    ...
    <style>
    /* 로그인 창 */
    #tel,#birth,#id {box-sizing: border-box;}
        .container{
            display: flex;
...
<%@ include file="../header.jsp" %>
            <div class="content">
                        <div class="login-wrapper">
                            ...
                            <form id="frm">
                            <div class="title"><h3 class="notice">FORGOT ID</h3></div>
                                <div class="login-content">
                                    ...
                                    <div><input type="id" name="id" id="id" readOnly="readonly" placeholder="찾은 아이디"></div>
                                    <div><input type="button" id="findIDBtn" value="FIND ID"></div>
                                </div>
                            </form>
                            <div class="find_info">
